defmodule TrainWhistle.AlarmControllerTest do
  ...
  @valid_attrs %{name: "myalarm", end_time: %{hour: 14, min: 0, sec: 0}, last_notified: %{day: 17, hour: 14, min: 0, month: 4, sec: 0, year: 2010}, start_time: %{hour: 14, min: 0, sec: 0}, travel_time: 42}
  @invalid_attrs %{}
  ...
  test "shows chosen resource", %{conn: conn} do
    alarm = Repo.insert! %Alarm{name: "myalarm"}
  ...
  test "updates and renders chosen resource when data is valid", %{conn: conn} do
    alarm = Repo.insert! %Alarm{name: "somealarm"}
